class ProgrammesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @programme.save
        format.html { redirect_to action: 'index', notice: 'Programme was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @programme.update(programme_params)
        format.html { redirect_to action: 'index', notice: 'Programme was successfully updated.' }
  ...
  private
    ...
    def programme_params
      params.require(:programme).permit(:title, engagements_attributes: [:id], works_attributes: [:id, :title, :opus, :composer, :duration, :_destroy])
    end
end
